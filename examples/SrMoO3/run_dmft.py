...
def dmft_abinitio():
    ...
    gs_tol = 1E-8
    gf_tol = 1E-3
    gs_bond_dims = [400] * 10 + [800] * 5 + [1500] * 5 + [2000] * 5 + [2500] * 5 + [3000] * 5
    gs_noises = [1E-3] * 5 + [1E-4] * 5 + [1E-5] * 5 + [1E-6] * 5 + [1E-7] * 12 + [0]
    gf_bond_dims = [200] * 2 + [500] * 2 + [800] * 2
    gf_noises = [1E-4] * 1 + [1E-5] * 1 + [1E-7] * 3 + [0]
    dmrg_gmres_tol = 1E-7
    dmrg_verbose = 2
